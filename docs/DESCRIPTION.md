...
|----------|-------------|
| [`DEPLOYMENT.md`](DEPLOYMENT.md) | Guide de déploiement production — Docker, PKI, secrets, scaling |
| [`AGENT_CLI.md`](AGENT_CLI.md) | Guide CLI agent — enrollment, configuration |
| [`SERVER_CLI.md`](SERVER_CLI.md) | Guide CLI serveur — init, setup, validation |
| [`TROUBLESHOOTING.md`](TROUBLESHOOTING.md) | Dépannage — problèmes courants et solutions |
