...
class AlertRepository(Protocol):
    ...
    async def list(self, filters: dict[str, Any], pagination: Pagination) -> Page[Alert]: ...
...
class DecisionRepository(Protocol):
    ...
    async def list_decisions(self, filters: dict[str, Any], pagination: Pagination) -> Page[Decision]: ...
...
class CaseRepository(Protocol):
    ...
    async def list(self, filters: dict[str, Any], pagination: Pagination) -> Page[ForensicCase]: ...
    async def append_custody(self, case_id: UUID, entry: dict[str, Any]) -> None: ...
